...
public interface BeanFactory {
	 ...
	 * 转义字符, 用于获取创建bean的factory, 例如有一个名为myJndiObject的bean是一个FactoryBean,
	 * &myJndiObject将得到的是这个factory,而不是由这个factory创建的bean实例.
	 */
	 ...
	 * 
	 * 通过名称获取bean对象时进行类型检查,即当名称对应的bean实例是否为指定的类型
	 */
	 ...
	 * @since 2.5
	 * 
	 * 根据名称获取bean,并给定构造参数,这只有当scope属性为prototype时生效,否则会抛出异常
	 */
